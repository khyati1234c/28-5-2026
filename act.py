...
if not HF_API_KEY:
    print("❌ HF_API_KEY not found. Add it to your .env file:")
    print("   HF_API_KEY=hf_xxxxxxxxxxxxxxxxxxxx")
    exit(1)
...
# Best free Vision-Language Models on HF router (mid-2025)
# Ordered by quality → speed tradeoff
MODELS = [
    "Qwen/Qwen2.5-VL-72B-Instruct",   # Best quality, strong VLM
    "Qwen/Qwen2.5-VL-32B-Instruct",   # Slightly faster, still excellent
    "Qwen/Qwen2.5-VL-7B-Instruct",    # Fast, lightweight fallback
    "google/gemma-3-12b-it",           # Google fallback
]
...
def to_data_url(img_bytes: bytes, path: str) -> str:
    """Convert image bytes to a base64 data URL with correct MIME type."""
